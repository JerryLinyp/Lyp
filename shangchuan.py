...
for result in results:
    ...
    # 为每个视频创建一个唯一的输出路径和 URL 基础部分
    unique_hash = hashlib.md5(video_path.encode()).hexdigest()
    output_video_path = f'C:/Users/38917/Desktop/improve/runs/output_video_{unique_hash}.mp4'
    url_base = f"{minio_config['endpoint_url']}/{minio_config['bucket_name']}/output_video_{unique_hash}"
    ...
    try:
        ...
        # 生成视频的 URL
        video_url = f"{url_base}/{output_video_path.split('/')[-1]}"
